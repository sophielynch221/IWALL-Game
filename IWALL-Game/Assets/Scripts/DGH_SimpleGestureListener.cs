...
public class DGH_SimpleGestureListener : MonoBehaviour, KinectGestures.GestureListenerInterface
{
	                              ...
	                              KinectInterop.JointType joint, Vector3 screenPos)
	{
		...
		///Switch/ case statements are like If statements
		///The parameter you put in the switch is like a variable you would test for 
		///multiple outcomes
		/// </summary>
		switch (gesture)
		{
